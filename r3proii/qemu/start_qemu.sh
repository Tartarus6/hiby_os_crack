...
KERNEL_IMAGE="../xImage"  # Path to extracted raw kernel (not uImage)
ROOTFS_IMAGE="rootfs.ext4"          # Path to your created root filesystem image
QEMU_ARCH="mips"                    # Use qemu-system-mips
