...
FOLDER_ROOT=${PROJECT_ROOT}/r3proii/unpacking_and_repacking
...
cp ${PROJECT_ROOT}/r3proii/original_firmware/r3proii.upt ./
7z x r3proii.upt
rm r3proii.upt
...
sudo mksquashfs ${PROJECT_ROOT}/r3proii/unpacking_and_repacking/squashfs-root ./rootfs.squashfs -comp lzo
...
cd $FOLDER_ROOT
mkisofs -o r3proii.upt -J -r ./temp/
...
echo "Firmware image saved as r3proii.upt"
echo ""
