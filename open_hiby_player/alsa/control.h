...
static __inline__ int snd_ctl_abort(snd_ctl_t *ctl)
{
        return snd_ctl_nonblock(ctl, 2);
}
...
static __inline__ int snd_hctl_abort(snd_hctl_t *hctl)
{
        return snd_hctl_nonblock(hctl, 2);
}
