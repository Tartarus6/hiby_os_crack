...
BIOS_IMAGE="${PROJECT_ROOT}/r1/xImage"                                    # Path to the BIOS image
KERNEL_IMAGE="${PROJECT_ROOT}/r1/Linux-4.4.94+.elf"                       # Path to extracted ELF kernel
ROOTFS_IMAGE="${QEMU_DIR}/rootfs-image"                                        # Path to your created root filesystem image
SQUASHFS_ROOT="${PROJECT_ROOT}/r1/unpacking_and_repacking/squashfs-root"  # Path to squashfs-root for initrd
